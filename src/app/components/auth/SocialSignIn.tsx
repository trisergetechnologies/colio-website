...
const SocialSignIn = () => {
  ...
  return (
    <motion.button
      ...
      className="group relative flex w-full items-center justify-center gap-3 rounded-xl bg-white px-6 py-4 text-slate-900 transition-all hover:bg-slate-50 hover:shadow-lg hover:shadow-purple-500/20"
    >
