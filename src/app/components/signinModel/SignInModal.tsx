...
import { X, Mail, ChevronLeft, User, Lock } from "lucide-react";
      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative h-[620px] w-full max-w-[420px] overflow-hidden rounded-[32px] bg-slate-900 shadow-2xl"
          >
            ...
            <button
              onClick={onClose}
              className="absolute right-5 top-5 z-20 flex h-8 w-8 items-center justify-center rounded-full bg-white/10 text-white backdrop-blur-md transition hover:bg-white/20"
            >
              <X size={18} />
            </button>
                ...
                {view === "landing" && (
                  ...
                  >
                    ...
                    <div className="mb-2 flex justify-center">
                      <div className="relative flex items-center gap-2 overflow-hidden rounded-full bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 px-5 py-2 shadow-lg shadow-purple-500/20">
                        <span className="text-lg">🎉</span>
                        <span className="text-xs font-bold text-white">
                          Get <span className="font-extrabold text-yellow-200">200 instant coins</span> on registration!
                        </span>
                      </div>
                    </div>
                    ...
                    <button
                      ...
                      className="mt-2 text-sm font-medium text-white/80 hover:text-white hover:underline"
                    >
